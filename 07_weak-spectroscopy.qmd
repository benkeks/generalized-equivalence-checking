...
and an `energy_game`, instantiated with the moves, a predicate `spectroscopy_defender` singling out defender positions, and the $\leq$-relation on 8-dimensional energies.{{<isb locale Spectroscopy_Game weak_spectroscopy_game>}}
...
This is more natural for the `case ... of ...` formulation in the formalization, but addresses a technicality that @bj2025silentStepSpectroscopyJournal handle in the proof body.
...
For the other direction, the following expresses @lem-weak-spectroscopy-game-completeness that attacks for formulas.{{<isb lemma Distinction_Implies_Winning_Budgets weak_spectroscopy_game.distinction_implies_winning_budgets>}}
...
I reproduce it here in full to provide some idea of what Isar proofs look like.{{<isb theorem Silent_Step_Spectroscopy weak_spectroscopy_game.spectroscopy_game_correctness>}}
