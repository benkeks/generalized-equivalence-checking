...
\begin{array}{l}
  ...
  \quad \variable{attacker\_win} := [ g \mapsto \varnothing \mid g ∈ G ] \\
  \quad \variable{todo} := \set{g ∈ G_\defender \mid g \ngamemoveblank} \\
  ...
  \quad \quad \kw{if} \variable{g} ∈ G_\attacker \colon \\
  ...
  \quad \quad \quad \kw{for} \variable{g'} ∈ (\variable{g} \gamemoveblank \cdot) \colon \\
  ...
  \quad \quad \quad \variable{todo} := \variable{todo} ∪ (\cdot \gamemoveblank \variable{g}) \\
