...
This fact is interesting because it means that the same equivalence may be characterized by different sublogics.
In particular, one may often find smaller characterizations as in the following example.

::: {#exm-game-formulas}

Consider $\observations{\floor{B}} \subseteq \hml$ characterized by the following grammar.
