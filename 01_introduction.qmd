...
The algorithm at the core of this thesis describes how to *decide all behavioral equivalences at once* for varying spectra of equivalence using *games that can count*.
...
It is written to be understandable on its own, but for details points to the original publications.

The following four main publications (with Benjamin Bisping as a main author) fuel the following chapters:
...
- **“Characterizing contrasimilarity through games, modal logic, and complexity”** [Information & Computation -@bm2024contrasimilarityInfComp] closes *gaps in the weak spectrum of equivalences* for games and their complexity and link to modal logics.
