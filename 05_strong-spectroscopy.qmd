...
The bisimulation game ${\game}_\notionname{B}$ of @sec-preliminaries *is a shadow of* the bisimulation energy game ${\game}_\notionname{B}^🗲$ of @sec-approach, which in turn *is a shadow of* the strong spectroscopy game $\gamespectroscopy$ of the present chapter.
