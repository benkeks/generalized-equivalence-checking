...
In particular, we solve the spectroscopy problem for *finite-state systems* and a hierarchy of semantic models for understanding nondeterminism and internal behavior in models of concurrent programs, known as the *weak linear-time–branching-time spectrum*, due to van Glabbeek.
