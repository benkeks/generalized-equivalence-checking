...
In particular, we solve the problem for finite-state processes and the *weak spectrum*, a hierarchy of semantical models of how to understand nondetermnism and internal behavior in concurrent programs.
On our way there, we also treat the *strong spectrum* of concrete processes.

The approach relies on a *quantiative understanding of spectra* in terms of how many syntactic features of Hennessy–Milner logic are used to characterize equivalences.
...
- Notation index
- Cover art
- More consistent game figures
- Instantiated grammars of strong spectrum 
