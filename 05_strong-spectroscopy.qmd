...
All prior publications with generalized game characterization of the spectum describe a hierarchy of reachability games---as opposed to our view of *one* energy game per system.
...
Therefore, the subset construction (or imperfect-information view) is technologically supperior.
...
1. @bjn2022decidingAllBehavioralEqs uses a reachability game, on which we construct distinguishing formulas.
  ...
  Introduced by @bisping2023equivalenceEnergyGames, we now can perform the whole *spectroscopy on energy vectors*, thereby making costy explicit formula construction optional.
...
3. On a pure rechability game, one cannot easily instantiate to select the subgraphs for individual equivalences as in @sec-deciding-individual-eqs.

{{< paragraph_heading "Back to many games." >}}
The point of *deriving equivalence games from the energy game* (@idea-instance-games) connects the one-energy-game approach back to the hierachy-of-games approach of prior publications.
...
The strong spectrum of equvialences is usually too strong for the analysis of concurrent systems.
...
Practical applications of concurency theory tend to need the weak semantics,
