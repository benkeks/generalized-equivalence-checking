...
::: {#fig-strong-spectroscopy-game fig-pos="t"}
...
the set of *strategy formulas* $\stratstrong(g, e)$ for a game position $g$ and a budget $e$ is defined inductively by the following rules:
$$
\dfrac{
  \begin{matrix}
