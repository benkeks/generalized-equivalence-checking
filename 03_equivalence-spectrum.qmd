...
TODO: Adapt upcoming proofs to fixed grammar
...
4. The observation language $\observationsvar[\literal{strong}]{(\infty, 1, 0, 0, 1, 1)}$ exactly matches failure observations $\observations{F}$ of @def-failures-modal.
:::
::: {.proof}
