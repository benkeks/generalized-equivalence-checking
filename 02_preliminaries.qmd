...
This *minimization* enables the handling of vastly bigger input models.
...
@alg-deciding-games describes how to compute who wins a finite reachability game for each position in time linear to the size of the game graph $\bigo{\relsize{\gamemoveblank}}$.
