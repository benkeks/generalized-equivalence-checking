...
To point out a similar distinction in the spectroscopy game, the attacker moves via $\step{\tau}$:
$$
\begin{array}{rcl}
...
However, we will achieve better complexity results in the next section, thanks to @lemke2024multiweightedEnergyGames.
:::
...
![](img/3d-games-dcon25.jpg){.lightbox}
