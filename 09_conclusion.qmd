...
@exm-leq-bisim-game notices that the subtractive $\leq$-game on natural numbers is an instance of the simulation game.
...
- There are various *quantitative notions*, often understood in terms of *behavioral distances*.
  ...
  Combining it with our game would likely demand deeper changes to our game mechanics, because one has to remember traces (and not just current states) to compute the resulting distances in generality.
