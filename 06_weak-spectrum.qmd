...
The *northpole of the weak spectrum* will be the logic of stability-respecting branching bisimilarity.
...
In @sec-weak-spectrum-quantities, we unfold the hiearchy of modal characterizations for the weak spectrum.
...
- Soft $\tau$-transitions to iteself and its immediate successor:
...
Next chapter's @sec-tackling-case-studies will pick up on the examples to test tnat the spectroscopy algorithm can indeed simplify a researcher's life.
...
In particulare, `compute_A_or_B` turns into a $\tau$-step.
