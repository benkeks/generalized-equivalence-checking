...
The simplified game part encodes nested conjunctions of the form $\hmlands\set{ \hmlopt{\alpha} \mathhli{\hmlands \Psi'}, \psi_1, \ldots}$ or the cheaper form $\hmlands\set{ \hmlopt{\alpha} \mathhli{\hmleps \hmlands \Psi'}, \psi_1, \ldots}$.
