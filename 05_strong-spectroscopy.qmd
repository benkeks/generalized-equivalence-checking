...
$\hmlobs{\literal{a}}\hmlands \set{ \hmlobs{\literal{b}}, \hmlobs{\literal{b}} \hmlands \set{\hmlobs{\literal{a}} }}$, which is not part of trace observations $\observationsvar{(\infty,0,0,0,0,0)}$.
::::
...
\ngamemoveblank$,
thereby getting the defender stuck using a trace budget of $(3,0,0,0,0,0) \leq (\infty,0,0,0,0,0) = \notionname{T}$.
