...
In @sec-deciding-individual-eqs, we discuss how to get rid of the blowup where possible when instantiating the game to *decide equivalences individually*.
...
- The third, fourth, and fifth dimensions limit how deeply observations may nest underneath a conjunction, for which they do not need to change themselves.
  The fifth stands for negated conjuncts, the third for one of the deepest positive conjuncts and the fourth for the other positive conjuncts.
...
Let us see how the instance game sizes behave on the games of @exm-spectroscopy-equivalence-checking!
...
The idea to alternate *state subsets for nondeterministic words and conjunction moves to eliminate the blowup* is introduced by @bisping2021ltbtsTacas.
