...
@fig-strong-grammars-linear and @fig-strong-grammars-branching give the grammars that are described through the coordinates in conjunction with @def-strong-spectrum.
The defining aspects of each gramamr are marked in $\textcolor{RoyalBlue}{\textrm{blue}}$.
...
This entails a lot of fineprint, which we will not reproduce here.
