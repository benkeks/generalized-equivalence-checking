...
@ails2007reactiveSystems [Equation 7.1] suggest the following specifation in CCS:
...
@trzeciakiewicz2021ltbtBrowserGame implements the computer game “The Spectroscopy Invaders” where one plays the attacker in the spectroscopy game.
...
The original CAAL (on <https://caal.cs.aau.dk/>) covers the curriculum of @ails2007reactiveSystems, including CCS processes, HML formulas and equivalence games.
