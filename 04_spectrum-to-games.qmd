...
::: {#idea-energy-games .callout-idea .callout-note}
...
::: {#idea-deciding-energy-games .callout-idea .callout-note}
...
::: {#prob-energy-game-problem .problem .callout-problem .callout-note}
...
the *monotonic energy game winner problem* (@prob-energy-game-problem).
:::
:::proof
...
For insance, we can observe the handling of non-invertibility:
...
\end{cases}.
$$
We denote as *flattened* monotonic energy game winner problem the variant of @prob-energy-game-problem that outputs
$$
