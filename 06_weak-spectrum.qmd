...
*Stable failures* demand a negative $\hmlneg\hmlobs{\tau}$-conjunct in the conjunctions of failures.
...
In summary, weak and stable failure equivalence are *incomparable.*
...
At this point, they are not particularly interesting, but the trivial conjuncts can be even bigger.

:::{#fig-weak-grammars-sim-like}
...
Call this avenue for gamification yet another perk of modal characterizations---besides the benefits of built-in transitivity and consistency, we have noticed along the way!