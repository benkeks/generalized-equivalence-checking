...
As we will discuss in more detail in @sec-equivio-peterson, our accompanying tool {{< equivio >}} answers the questions of @exm-peterson-mutex in a small query.
Here is an excerpt:
...
By running *one* simple algorithm, the tool decides *twenty-six* equivalence (and preorder) problems on $\literal{Pe}$ and $\literal{Mx}$.
...
\begin{adjustbox}{max width=\textwidth, center}
  ...
  \tikzstyle{every node}=[font=\normalsize, align=center]
    ...
    \draw  (4.05,1.4) rectangle  node {Modal logics \\ \ref{sec-hml}}
     (7.95,0.1);
    \draw  (8.05,1.4) rectangle  node {Games \\ \ref{sec-games}} (11.9,0.1);
    ...
    \node at (9,3.75) {\textbf{Approach:} \\ \textbf{equivalence energy games} \\ Chapter \ref{sec-approach}};
...
Chapters and ideas built upon those underneath.
:::
...
We close with a discussion of the wider picture in @sec-conclusion and how this thesis ascends through a *hierarchy of game charcaterizations*.
