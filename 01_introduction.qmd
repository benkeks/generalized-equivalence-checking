...
\noindent
The big blue circle ![](img/equivio-eq.svg){width=0.9em} indicates that weak simulation indeed is the finest equivalence to equate $\literal{Pe}$ and $\literal{Mx}$.
...
We close with a discussion of the wider picture in @sec-conclusion and how this thesis ascends through a *hierarchy of shadows*.
