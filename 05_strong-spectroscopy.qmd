...
The core ingredient of this chapter is a richer energy game, we dub “spectroscopy game,” to be presented in @sec-stong-spectro-game.
...
\begin{tikzpicture}[auto,node distance=1.1cm,
  ...
  \node[text=TealBlue, right=2mm of AttackerWinningBudgets, align=right] (Sec51) {Section \ref{sec-stong-spectro-game} \\ and \ref{sec-specific-spectro-games}};
...
- The third, fourth, and fifth dimensions limit how deeply observations may nest underneath a conjunction, for which they do not need to change themselves.
  The third stands for one of the deepest positive conjuncts and the fourth for the other positive conjuncts; the fifths stands for negative conjuncts.
