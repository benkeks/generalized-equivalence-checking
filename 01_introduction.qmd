...
They are split into two formalizations:
...
- *“The weak spectroscopy game to characterize behavioral equivalences”* formalizes the core results of @sec-weak-spectrum and @sec-weak-spectroscopy: <https://proofs.equiv.io/AFP/Weak_Spectroscopy/>.
  The theory [@bhlmmb2025weakSpectroscopyIsabelle] has been developed together with TU Berlin students Barthel, Hübner, Lemke, Mattes, and Mollenkopf.
  Also, many theorems of earlier chapters can be understood to be supported by the formalization.
- *“Equivalence spectrum formalization”* supplies proofs for @sec-preliminaries and @sec-spectrum: <https://proofs.equiv.io/AFP/Lineartime_Branchingtime_Spectrum_I/>.
