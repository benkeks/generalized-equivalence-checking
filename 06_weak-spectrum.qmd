...
We use the higher coordinate $(\infty, 0, 0, \infty, 0, \infty, \infty, \infty)$ with positive conjuncts for stable bisimulation in @fig-weak-spectrum to highlight that stable bisimulation preorder is finer than stable simulation preorder and its variants.
