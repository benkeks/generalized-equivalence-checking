...
### Abstraction as Congruence---and Stable Failures  
...
The first interesting feature is an effect of some languages not enforcing top-level negation as observed in @bj2024silentStepSpectroscopyExpress [Ex. 2.5].
...
@bj2025silentStepSpectroscopyJournal [§ 3.3] proves in detail, for each of our abstractions of bisimilarity, that it corresponds to its respective relational characterization.
...
TODO: Stable bisim etc.

@rem-ambiguous-coordinates on ambiguous coordinates not always the least
...
At this point, they are not particularly interesting, but the trivial conjuncts can be even less well-behaved.
