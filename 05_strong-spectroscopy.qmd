...
This difference is reflected in the game by @def-strong-spectroscopy-game charging for conjunctions $-\unit{2}$ after the defender conjunction positions instead of before.
...
::: {#thm-strong-spectroscopy-game-characterization}
$p \bpreordvar{\observationsvar{e}} q$ for $e ∈ \notions^\literal{strong}$ precisely if the defender wins if the attacker starts with budget $e$.
:::
...
TODO: Example derived game

TODO: Explain conjunction optimization Justfiy optimization through prior bisim game...
