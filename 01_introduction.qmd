...
The first time I had to face the question formally was when working as a student research assistant:
...
But it is not straightforward how to use the spectrum to decide for a given pair of processes which of the many equivalences apply.
