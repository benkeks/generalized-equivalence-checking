...
Consider the following parameters of an energy game problem on $\game^🗲=(G,G_\defender,\gamemoveblank, \abstractupdate)$ where the energies at leas form a finite bounded $\lub$-semi-lattice $(\abstractenergies, \leq)$:
