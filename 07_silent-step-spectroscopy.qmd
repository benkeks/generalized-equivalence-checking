...
In light of our finding, this cannot be right.^[
  The bug in @gfm2020congruenceOperator is that the modal logic of weak failures is not closed under adding of weak observation sequences at $\hmleps$-operators:
