...
Observe that all the coordinates of the strong linear-time–branching-time spectrum (@def-strong-ltbt-spectrum
The `@check` keyword performs individual comparisons on {{<equivio>}}.) are still covered by the simpler spectrum.
