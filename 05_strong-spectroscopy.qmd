...
:::
:::proof
The move $(\attackerpos{p, Q}, e) \gamemoveblank (\attackerpos{p', Q'}, e')$ must be due to a transition $p \step{α} p'$ with $Q \step{α} Q'$. 
...
The bisimulation game ${\game}_\notionname{B}$ of @sec-preliminaries *is a shadow of* the bisimulation energy game ${\game}_\notionname{B}^🗲$ of @sec-approach *is a shadow of* the strong spectroscopy game $\gamespectroscopy$ of the present chapter.
