...
Consider vector energies $\abstractenergies = \nats^2$ with pointwise order and the energy game with graph in @fig-simple-energy-game.
...
\end{tikzpicture}
```
Attacker's 3D Pareto front for $[\literal{Q}, \literal{T}]$ of the example bisim energy game.
::::
