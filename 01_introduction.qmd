...
- TODO @sec-strong-spectrum applies the approach to decide the whole strong spectrum through one *game for linear-time--branching-time spectroscopy*.
- TODO @sec-weak-spectrum adapt the game for the *weak spectrum of equivalences accounting for silent-steps*.
