...
The algorithm at the core of this thesis presents the ideas necessary to *decide all behavioral equivalences at once* for varying spectra of equivalence using *games that can count* to *limit possible distinctions through attacker energy budgets*.
