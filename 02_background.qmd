...
\begin{adjustbox}{max width=\textwidth, center}
  \begin{tikzpicture}[>->, shorten <=1pt, shorten >=0.5pt, auto, node distance=2cm,
    ...
    \node[posStyle, defender]
      (Dfn_b_q2_q3) [below right = .1cm and 1.6cm of Att_qab_q3] {$(\literal{b}, \literal{q_2}, \literal{q_3})$};
    \node[posStyle, defender, defWins]
    ...
    \path
      ...
      (Att_qab_q3)
        edge[bend left = 60] node {} (Att_q3_qab)
      (Att_q3_qab)
        edge[bend right = 65] node[swap] {swap} (Att_qab_q3)
      (Dfn_t_qab_Qp)
      ...
      (Att_Qp_Q)
        ...
        edge node {$\literal{Q'} \step{\tau} \literal{q_{AB}}$} (Dfn_t_qab_Q)
        edge node {$\literal{Q'} \step{\tau} \literal{q_{3}}$} (Dfn_t_q3_Q)
      (Dfn_t_qab_Q)
