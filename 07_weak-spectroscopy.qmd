...
For this, the theory uses the inductive characterization of $\attackerwins$ in @prp-winning-budget-rules as definition for `attacker_wins`.{{<isb lemma Strategy_Formulas lts_tau.winning_budget_implies_strategy_formula>}}
