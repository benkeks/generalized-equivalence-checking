...
The set of *strategy formulas* for a game position $g$ and a budget $e$, $\stratweak(g, e)$, in the context of a weak spectroscopy game $\gamespectroscopyw^{\system}$ is defined inductively by the rules in @fig-weak-spectroscopy-strategy-formulas and @fig-weak-spectroscopy-strategy-formulas-cont.{{<isb inductive Strategy_Formulas weak_spectroscopy_game.strategy_formula>}}
:::
...
\inferrule[negative\, conjunct]{
  \attackerpos[\land]{p,q} \gamemove{u} \attackerpos[\varepsilon]{q,P'} \quad
  e' = \energyupdate(u, e) \in \attackerwins(\attackerpos[\varepsilon]{q,P'}) \\
  \chi \in \stratweak(\attackerpos[\varepsilon]{q,P'}, e')
} {
  \hmlneg \hmleps\chi \in \stratweak(\attackerpos[\land]{p,q}, e)
}
