...
- `@comment "My comment"` –
  Any `@...` tag without features can serve to add comments in the model.
...
Mx2(main, x=120, y=0)
Mx2 = tau.ecA.lcA.Mx2 + tau.ecB.lcB.Mx2
@compareSilent Pe, Mx2
...
@comment "Interestingly: Weak ready "
```
