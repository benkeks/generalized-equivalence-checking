...
We will be working with lattices $(\notions, \leq)$ of notions of behavioral equivalence.
...
TODO: introduce illustration notation for lattices
...
Then $\set{\varnothing, \set{1}, \set{1,2}, B}$ forms a chain, because its members are ordered linearly $\varnothing \subset \set{1} \subset \set{1,2} \subset B$.
$\set{\set{1}, \set{2}, \set{3}}$ forms an anti-chain, because its members do not include each other.
