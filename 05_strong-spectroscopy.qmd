...
\begin{tikzpicture}[auto,node distance=1.1cm,
  ...
  \path
    ...
    (EnergyGame) edge[->, draw=TealBlue] node {Algorithm~\ref{alg-deciding-energy-games}} (AttackerWinningBudgets);
  ...
  \path
    ...
    (ReachabilityGame) edge[->, draw=Peach] node {Algorithm \ref{alg-deciding-games}} (AttackerWinningReachability)
