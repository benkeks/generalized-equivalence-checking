...
The resulting spectroscopy algorithms are exponential for the $\complexityclass{PSPACE}$-hard spectrum of equivalence problems, but can be instantiated to polynomial-time solutions on the $\complexityclass{P}$-easy part.
