...
::: {#lem-declining-update-complexity-bounded}
@alg-deciding-energy-games solves the *abstracted* energy game problem on an $N$-dimensional declining energy game $\game^🗲=(G,G_\defender,\gamemoveblank, w)$ in
TODO
:::

### Spectroscopy Complexity
