...
::: {#lem-ccs-congruences}
The operators of CCS (@def-ccs) are congruences for trace equivalence and bisimilarity on the CCS transition system (@def-ccs-semantics).
:::
:::proof
