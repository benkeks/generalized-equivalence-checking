...
As $\traces{\literal{pA}} = \set{\emptyword, \literal{a}} ⊆ \set{\emptyword, \literal{a}, \literal{b}} = \traces{\literal{qAB}}$, $\literal{pA}$ is (strictly) trace-preordered to $\literal{qAB}$, $\literal{pA} \bpreord{T} \literal{qAB}$.
