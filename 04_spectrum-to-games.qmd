...
Other dimensions of the strong spectrum are effectively set to $∞$.
...
@fig-polynomial-strong-spectrum gives names to coordinates that correspond to notions discussed previously.^[
  The coordinate for enabledness $(1,0,0)$ unfolded to the original strong system, $(1,∞,∞,∞,0,0)$ differs from the one previously used $(1,0,0,0,0,0)$.
  But the characterized language is equally distinctive.
  TODO: Proof.
]
