...
But @thm-game-formulas transports a deeper insight.

The bisimulation game actually is a game of an attacker assembling a distinguishing formula from $\observations{\floor{B}}$.
The rules for attacker moves follow the grammar of $\observations{\floor{B}}$.
...
In later chapters, we will rather derive equivalence games from grammars of modal formulas (@idea-modal-first), to generalize the framework of @fig-game-algo-overview for whole spectra of equivalence.
