...
Eequivalence hierarchy including failures.
::::
...
As @lem-spectrum-characterization will show, both languages are equally distinctive (@def-leq-distincitve).
...
However, there is a polynomial-time-easy part of the spectrum around bisimilarity and (ready) similarity.
