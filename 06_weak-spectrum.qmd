...
We will reframe a big chunk of “The Linear Time–Branching Time Spectrum II: The Semantics of Sequential Systems with Silent Movea” [@glabbeek1993ltbt] to fit our modal framework.
...
@sec-weak-equivalences-in-general will provide some preliminaries and define the $\hml$ subset, which will correspond to the notion of stability-respecting branching bisimilarity.
...
For most process algebras, weak failures are *too strong* in this regard:
The example also shows that weak failures cannot be a congruence for any hiding operator!

TODO: RvG und CSP decisions
TODO: Closing hint: congruence even messier in the weak spectrum, e.g. weak bisim not congruence for +.
...
\begin{tikzpicture}[auto,node distance=2.5cm,align=center]
  ...
  \node (U)[below of=E, node distance=1.2cm]{weak enabledness $\notionname{WU}$\\
