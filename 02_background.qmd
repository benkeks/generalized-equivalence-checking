...
To talk about programs in this thesis, we use Milner's [-@milner1989comcon] *Calculus of Communicating Systems* (CCS).
It is like a concurrent programming language that fits in your pocket (and can properly be described mathematically).
