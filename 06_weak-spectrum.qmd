...
Let us consider the following two abstractions of failure equivalence (@def-failures):
...
Many process algebras have an operator to perform such an *abstraction*, for instance, mCRL2's `hide` or CSP's hiding $\setminus$.
