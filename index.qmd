...
In particular, we solve the spectroscopy problem for *finite-state systems* and a hierarchy of semantical models of how to understand nondeterminism and internal behavior in models of concurrent programs, known as the *weak linear-time–branching-time spectrum*, due to van Glabbeek.
On our way there, we also treat the *strong spectrum* (without internal behavior) as well as applications of generalized equivalence checking in verification and concurrency theory.
...
We prove the equivalences and preorders to be captured by *spectroscopy games* where energy budgets bound the features an attacker may use to express differences of states.
...
We implement the spectroscopy procedure in the web tool {{< equivio >}}, which continues a tradition of concurrency workbenches.
...
- **Environment:**
  Uwe Nestmann and my colleagues at the Modelle und Theorie Verteilter Systeme group, especially my lovely office mates Edgar Arndt, Valeria Zahoransky.
