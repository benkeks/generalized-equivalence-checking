...
We now return to our examples from @sec-case-stduies-other-eqs, and see how the spectroscopy approach can handle the two.
For this, we will use the {{<equivio>}} CCS dialect.
