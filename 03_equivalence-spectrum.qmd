...
::: {#nte-idea-hierarchy .callout-note}
...
::: {#nte-idea-spectroscopy .callout-note}
...
In the context of a $\glb$-complete spectrum $(\notions, \leq, \observationsvar{N \in \notions})$, the *expressiveness price* of a formula $\varphi$ that appears in one of the logics is defined as
...
@mattes2023expressivePowerHML proves in Isabelle/HOL that the coordinate system of the conference version of this spectrum [@bisping2023equivalenceEnergyGames] match distinctiveness of the modal characterizations in [@glabbeek2001ltbtsiReport].
