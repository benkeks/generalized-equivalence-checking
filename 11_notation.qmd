...
| $A^*$, $A^{\omega}$, $A^{\infty}$     | Language of finite / infinite / finite-or-infinite words over $A$                     |
| $\inverse{\rel R}$      | Inverse relation of $\rel R$                                               |
| $\nats$, $\natsext$     | Natural numbers / natural numbers extended by a $\infty$ as $\top$-element |
| $\defeq$                | Definitional equality; in the context of CCS, $\literal{X} \defeq P$ also means $\ccsasg(\literal{X}) \defeq P$ (@def-ccs-semantics); in the context of pseudocode, assignment of variables |
...
|                   |                                                                                     |
|--------------------------|----------------------------------------------------------------------------------------------|
| $\leq$                 | less-or-equal-to, usually pointwise on vectors                                                |
...
| “$\varphi$&nbsp;distinguishes”   | Formula true for state on left-hand side and not true for state(s) on right-hand side (@def-distinctions, -@def-distinguishes-set)  |
